<script lang="ts" context="module">
	...
	export const buttonStyles = tv({
		...
		variants: {
			variant: {
				default:
					'bg-primary hover:bg-primary-focus text-primary-foreground focus-visible:ring-primary [box-shadow:_inset_0_1px_0.5px_0px_hsl(0_0%_100%/0.4)] dark:[box-shadow:_inset_0_-1px_0.5px_0px_hsl(240_6%_10%/0.4)]',
				outline:
					'shadow dark:shadow-black ring-1 ring-base-950/10 focus-visible:border-border border border-transparent dark:border-border text-foreground hover:bg-border focus-visible:ring-border',
				secondary:
					'bg-base-200/90 hover:bg-muted dark:bg-base-900/70 dark:hover:bg-muted focus-visible:ring-border [box-shadow:_inset_0_1px_0.5px_0px_hsl(0_0%_100%/0.06)]',
				error:
					'bg-error hover:bg-error-focus text-error-foreground focus-visible:ring-error [box-shadow:_inset_0_1px_0.5px_0px_hsl(0_0%_100%/0.4)]',
				success:
					'bg-success hover:bg-success-focus text-success-foreground focus-visible:ring-success [box-shadow:_inset_0_1px_0.5px_0px_hsl(0_0%_100%/0.4)]',
				warning:
					'bg-warning hover:bg-warning-focus text-warning-foreground focus-visible:ring-warning [box-shadow:_inset_0_1px_0.5px_0px_hsl(0_0%_100%/0.4)]',
...
<script lang="ts">
	...
	import type { BuilderReturn } from '@melt-ui/svelte/internal/helpers';
	...
	export let use: [any, {}?] = [() => {}, {}];
	export let _melt: BuilderReturn<any, any, any, any> | undefined = undefined;
	...
	type Props = {
		...
		loading?: boolean;
		use?: [Action, {}?];
		_melt?: BuilderReturn<any, any, any, any> | undefined;
	};
